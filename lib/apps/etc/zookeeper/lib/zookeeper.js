...
const logger = runtime_1.Logger.getLogger('app:zookeeper');
const versions = {
    '3.9': '3.9',
    '3.8': '3.8',
    '3.7': '3.7'
};
class ZookeeperController extends runtime_1.ClusterAppController {
    deploy() {
...
exports.default = ZookeeperController;
